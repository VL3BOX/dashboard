<template>
  <div class="m-dashboard m-dashboard-work m-dashboard-whitelist">
    <div class="m-dashboard-whitelist-cont">
      <!-- title -->
      <h2 class="u-title">
        <span class="i-title"><i class="el-icon-copy-document"></i> 我的亲友</span>
        <span class="u-sort" @click="isDrag = true" v-if="!isDrag"><i class="el-icon-sort"></i> 排序</span>
        ...
        <transition-group type="transition">
          <div class="u-item" v-for="item in list" :key="item.id">
            <div class="u-item-box">
              <img :src="item.kith_info.user_avatar || avatar" />
    ...
    exitDrag() {
      ...
      if (this.dragList == true) {
        ...
        for (let i = 0; i < list.length; i++) {
          ...
          arr.push({ level: list[i].level, kith_id: list[i].kith_id })
        }
