<template>
    <nav class="m-nav">
        <a class="m-nav-publish el-button el-button--primary" href="./publish"><i class="el-icon-edit-outline"></i><span>发布中心</span></a>
        ...
        <div class="m-nav-group">
            ...
            <router-link to="/wiki"><img svg-inline src="../assets/img/nav/repo.svg" /><span>百科贡献</span></router-link>
