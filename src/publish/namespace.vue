    ...
    <div class="m-dashboard-publish-namespace m-publish-box">
        ...
        <div class="m-publish-namespace-box">
            <header class="m-publish-namespace-header">
                ...
                <div class="u-count">
                    <span class="u-count-txt">当前可建铭牌数： <b>{{ count }}</b> 个</span>
                    <a
                        ...
                        >购买铭牌</a
                    >
                    <a href="/vip/namespace/#discount?from=dashboard_namespace_create" class="u-skip" target="_blank"
