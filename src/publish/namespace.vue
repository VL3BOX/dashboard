    ...
    <div class="m-publish-namespace-box">
      <header class="m-publish-namespace-header">
        <div class="u-tip">
          ...
          <a href="https://剑网3.com/某某气纯宏" target="_blank"><b>剑网3.com/某某气纯宏</b></a>
          访问你输入的链接
        </div>
        <div class="u-count">
      ...
      <el-form class="m-publish-namespace-form" :rules="rules" :model="form">
        ...
        <el-form-item label="">
          <el-button class="u-submit" type="primary" :disabled="!ready || processing" @click="onSubmit">提交</el-button>
        </el-form-item>
      </el-form>
    </div>
  </div>
...
export default {
  ...
  data: function() {
    return {
      ...
      processing: false,
      rules: {
        key: [{ required: true, message: '请输入铭牌名称', trigger: 'blur' }],
        link: [{ required: true, message: '请输入链接网址', trigger: 'blur' }],
      },
    }
  },
  computed: {
