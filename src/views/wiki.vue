<template>
    <div class="m-dashboard m-dashboard-work m-dashboard-wiki">
        <el-tabs v-model="active_name">
            <el-tab-pane label="百科攻略" name="wiki_post">
                <el-input
                ...
                <div class="m-dashboard-box">
                    ...
                    >
                        <li
                            v-for="(post, key) in achievement_post.data"
                            :key="key"
                        >
                            <span
                                class="u-tab"
                                v-text="getTypeLabel(post.type)"
                            ></span>
                            <a
                                class="u-title"
                                target="_blank"
                            ...
                            <span v-if="post.checked == 2" class="u-mark reject"
                                >❌ 审核驳回</span
                            >
                            <span v-if="post.checked == 3" class="u-mark hold"
                                >🔐 等待验证</span
                            >
                            <div class="u-desc">
                                <span
            ...
            <el-tab-pane label="百科评论" name="wiki_comment">
                <el-input
                    class="m-dashboard-work-search u-source-search"
                    placeholder="请输入搜索内容"
